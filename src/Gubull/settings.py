"""
Django settings for Gubull project.
...
SECRET_KEY = 'px=g!%!@r3n$m3zdm6(qki6z63r69#0aljo09$4!0!-ngip7%z'
...
WSGI_APPLICATION = 'Gubull.wsgi.application'
